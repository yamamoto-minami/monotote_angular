/**
 * Original source: https://github.com/alexcrack/angular-ui-notification
 */

angular.module('cmp.notification',[]);

angular.module('cmp.notification').provider('Notification', function() {
